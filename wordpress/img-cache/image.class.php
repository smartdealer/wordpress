...
// - - - - - - - - - - - - - - - - - - -
//  ind total image for vehicle on system
// - - - - - - - - - - - - - - - - - - -

function FindTotalImage($folderContent) {

	// read image folder image
	$folderContent = file_get_contents($folderContent);
	
	if(preg_match('/erro|not\sfound|fail/i',$folderContent))
		return false;
	
    // decode received JSON
	return json_decode($folderContent);
