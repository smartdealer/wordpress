                                    ...
                                    <div class="item">
                                        <div class="item-img">
                                            <a href="<?php echo SmartDealer::img($row['id'], null, null, 640, $i, true) ?>" data-toggle="lightbox" data-gallery="multiimages" data-title="<?php echo $title ?>">
                                                <img class=" img-responsive" src="<?php echo SmartDealer::img($row['id'], null, null, 180, $i, true) ?>" alt="<?php echo $i ?>" />
                                            </a>
                                        </div>
                                    </div>
                                <?php endforeach ?>
                ...
                <div class="col-md-4 form-proposer">
                    <form action="<?php echo SmartDealer::formAction(); ?>" method=post class="form-captcha" onsubmit="this.submit.disabled = true; this.submit.value = 'Enviando..';">
                        ...
                        <div class="col-lg-12">
                            ...
                            <input type=hidden name=modal value="<?php echo SmartDealer::encodeData('usados'); ?>">
                            <input type=hidden name=id value="<?php echo SmartDealer::encodeData($row['id']); ?>">
                            <input type=hidden name=placa value="<?php echo SmartDealer::encodeData($row['placa']); ?>">
                            <input type=hidden name=desc value="<?php echo SmartDealer::encodeData($row['marca'] . ' - ' . $row['modelo']); ?>">
                        </div>
                    </form>
