                                                                ...
                                                                <div class="image">
                                                                    ...
                                                                    <a href="<?php echo SmartDealer::link($row['id'], $row['modelo']); ?>" class="rmv_txt_drctn">
                                                                        <div class="image-inner">
                                                                            <!--Badge-->
                                                                            <img width="300" height="auto" src="<?php echo SmartDealer::urlPlugin('template/default/assets/img/pre-img.jpg'); ?>" data-src="<?php echo SmartDealer::img($row['id'], null, null, 257, 1, true) ?>" alt="<?php echo $row['modelo']; ?>" class="img-responsive wp-post-image lazy" alt="">		
                                                                        </div>
                                                                    </a>
                                                                </div>
                                                                <div class="content">
