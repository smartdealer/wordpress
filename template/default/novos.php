    ...
    <section>
        <div class=container>
            <div class="class-md-12 text-center">
                ...
                <h4>O carro dos seus sonhos está aqui</h4>
            </div>
    </section>
                        ...
                        <?php if ($data && is_array($data)) : ?>
                            <?php foreach ($data as $row) : ?>
                                ...
                                <div class="col-lg-4 col-md-6 col-sm-12 col-xs-12 row-item" id="gallery">
                                    <div class=item>
                                        <a href="<?php echo SmartDealer::link($row['veiculo_chassi'], $row['modelo'], true) ?>">
                                            <div class="item-image">
                                                <img src="<?php echo SmartDealer::img($row['id'], $img[0], $img[1], 350) ?>" alt="<?php echo $row['modelo'] ?>" class="img-responsive">
                                            </div>
                                            ...
                                            <div class="price-label"><?php echo SmartDealer::preparePrice($row['preco'], 1) ?></div>
                                        </a>
                                    </div>
                                </div>
