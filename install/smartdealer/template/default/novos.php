                                            ...
                                            <div class="row row-pad-top-24">
                                                <div class="col-md-12 col-sm-6 stm-filter_condition" style="padding-bottom: 15px;">
                                                    <div class="input-group">
                                                        <input type="text" class="form-control" placeholder="Busque.." aria-label="Busque.." name="busca" value="<?php echo SmartDealer::formGet('busca'); ?>">
                                                                ...
                                                                <div class="content">
                                                                    <div class="meta-top">
                                                                        ...
                                                                        <div class="title heading-font">
                                                                            <a href="<?php echo SmartDealer::link($row['veiculo_chassi'], $row['modelo']); ?>" class="rmv_txt_drctn"><?php echo SmartDealer::prepareString($row['modelo'], true) ?></a>
                                                                        </div>
                                                                    </div>
                                                                    <!--Item parameters-->
