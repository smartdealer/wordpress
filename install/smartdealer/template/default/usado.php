                                ...
                                <?php if ($tot): ?>
                                    <?php foreach ($tot as $i): ?>
                                        <div class="stm-single-image" data-id="big-image-<?php echo $i; ?>">
                                            <a href="<?php echo SmartDealer::img($row['id'], null, null, 1024, $i, true) ?>" class="stm_fancybox" rel="stm-car-gallery">
                                                <img width="800" height="auto" src="<?php echo SmartDealer::img($row['id'], null, null, 800, $i, true) ?>" class="img-responsive wp-post-image" alt="<?php echo $title ?>" />				
                                            </a>
                                        </div>
                                    <?php endforeach ?>
                                <?php endif; ?>
                                ...
                                <?php if ($tot): ?>
                                    <?php foreach ($tot as $i): ?>
                                        <div class="stm-single-image" id="big-image-<?php echo $i; ?>">
                                            <img width="300" height="auto" src="<?php echo SmartDealer::img($row['id'], null, null, 300, $i, true) ?>" class="img-responsive wp-post-image" alt="<?php echo $title ?>"/>				
                                        </div>
                                    <?php endforeach ?>
                                <?php endif; ?>
                            </div>
                        ...
                        <div class="single-car-data">
                            <table>
                                <tr>
                                    ...
                                    <td class="t-value h6">Seminovos</td>
                                </tr>
                                <tr>
                                ...
                                <tr>
                                    ...
                                    <td class="t-value h6"><?php echo $row['km']; ?></td>
                                </tr>
                                <tr>
                                        ...
                                        <div role="form" class="wpcf7" id="wpcf7-f5283-p5657-o1" lang="en-US" dir="ltr">
                                            ...
                                            <form action="<?php echo SmartDealer::formAction(); ?>#wpcf7-f5283-p5657-o1" method="post" class="wpcf7-form mailchimp-ext-0.4.50" novalidate="novalidate">
                                                <div style="display: none;">
                                                    ...
                                                    <input type="hidden" name="_wpcf7_unit_tag" value="wpcf7-f5283-pp5657-o1" />
                                                ...
                                                <?php endif; ?>
                                                <p style="display: none !important"><span class="wpcf7-form-control-wrap referer-page"><input type="hidden" name="referer-page" value="http://www.itauto.com.br/?taxonomy=condition&term=seminovos" class="wpcf7-form-control wpcf7-text referer-page" aria-invalid="false"></span></p>
